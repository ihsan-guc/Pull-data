...
# Matris oluşturmamızın asıl sebebi tek tek veri girerek zaman harcamak yerine 
# ilk matris = [['URL kısmını'][Sayfa Sayısını]] Yazdık ve ne kadar veri girerseniz o kadar çok veri çekecektir.
matris = [
